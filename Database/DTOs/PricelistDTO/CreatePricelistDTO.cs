...
namespace Database.DTOs.PricelistDTO
{
    ...
    {
        public CreatePricelistDTO(int clid, string plname, int pltype, int sectbid, int seastbid, bool plactive, decimal price, decimal minprice, bool prgcoef, int pltarg, bool use2, int sectbid2, int sectb2st, int sectb2en, int valfrom, int valto, bool mgtype) 
